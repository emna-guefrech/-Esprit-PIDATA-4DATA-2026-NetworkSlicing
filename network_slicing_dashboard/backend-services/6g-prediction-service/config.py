"""
Configuration for 6G Prediction Service
"""

import os

# Model paths (relative to shared/models)
MODEL_PATHS = {
...
SERVICE_NAME = "6g-prediction-service"
...
# 6G specific configuration
SUPPORTED_OBJECTIVES = ["5.1", "5.2", "5.3"]
CLASSIFICATION_CLASSES = ["Normal", "Light", "Critical"]
REGRESSION_RISK_LEVELS = ["Low Risk", "Medium Risk", "Poor Performance", "Critical Risk"]
ANOMALY_SEVERITY_LEVELS = ["Normal", "Low", "Medium", "High"]
