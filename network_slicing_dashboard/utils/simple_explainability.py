#!/usr/bin/env python3
"""
Simple SHAP-like explainability system for 6G Network Slicing
"""
...
def create_simple_explanation(features: dict) -> dict:
    ...
    return {
        ...
        'explanation': f"Based on the input parameters, the most influential factors are: {', '.join([f"{feat} ({score:.1f})" for feat, score in sorted_features[:3]])}"
    }
...
joblib.dump(create_simple_explanation, 'C:/Users/EYA/PI/network_slicing_dashboard/utils/simple_explainability.joblib')
